 ...
 * @author Home
 */
public class BurgerToppings extends javax.swing.JDialog {

    private Menu myFrame;
    private OrderContext orderContext;
    private ComboExpression comboExpression;

    public BurgerToppings(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public class BurgerOrderBuilder {
        ...
        public BurgerOrderBuilder setFoodName(String foodName) {
            this.foodName = foodName;
            return this;
        }

        public BurgerOrderBuilder setToppings(String toppings) {
            this.toppings = toppings;
            return this;
        }

        public BurgerOrderBuilder setCommand(String command) {
            this.command = command;
            return this;
        }

        public BurgerOrderBuilder setPrice(String price) {
            this.price = price;
            return this;
        }
    ...
    public class BurgerOrder {
        ...
        private BurgerOrder(BurgerOrderBuilder builder) {
        ...
        public String getFullOrder() {
            return foodName + " " + toppings + "( " + command + ")";
        }
    ...
    public class PizzaOrderBuilder {
        ...
        public PizzaOrderBuilder setType(String type) {
            this.type = type;
            return this;
        }

        public PizzaOrderBuilder setToppings(String toppings) {
            this.toppings = toppings;
            return this;
        }

        public PizzaOrderBuilder setCommand(String command) {
            this.command = command;
            return this;
        }

        public PizzaOrderBuilder setPrice(String price) {
            this.price = price;
            return this;
        }
...
// Terminal Expressions
    class ExtraCheeseExpression implements OrderExpression {
        ...
        public void interpret(OrderContext context) {
            context.addToOrder("Extra Cheese");
        }
    }

    class ExtraKimchiExpression implements OrderExpression {

        @Override
        public void interpret(OrderContext context) {
            context.addToOrder("Extra Kimchi");
        }
    }
   ...
   private boolean interpretCommand(JTextField userInputField) {
    ...
    for (String command : commands) {
        switch (command.trim().toLowerCase()) {
            case "extra cheese":
                comboExpression.addExpression(new ExtraCheeseExpression());
                break;
            case "extra kimchi":
                comboExpression.addExpression(new ExtraKimchiExpression());
                break;
            default:
...
/////////////////////////////////////////////Interprter Pattern////////////////////////////////////////////////////////////////////////////////
    private void updatePrice1(JCheckBox selectedCheckBox) {
        ...
        BurgerToppings.Topping topping = toppingFactory.getTopping(selectedToppingName, price);
        updatePrice(topping, jLabel6, selectedCheckBox.isSelected());
    }

    private void updatePrice2(JCheckBox selectedCheckBox) {
        String selectedToppingName = selectedCheckBox.getText();
        double price = 90.00;  // Set the default price or retrieve it based on the topping name
    ...
    private void updatePrice3(JCheckBox selectedCheckBox) {
        String selectedToppingName = selectedCheckBox.getText();
        double price = 240.00;  // Set the default price or retrieve it based on the topping name
    ...
    private void updatePrice4(JCheckBox selectedCheckBox) {
        String selectedToppingName = selectedCheckBox.getText();
        double price = 200.00;  // Set the default price or retrieve it based on the topping name
    ...
    private void initComponents() {
        ...
        jCheckBox3.setText("Cheese Slice");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (interpretCommand(jTextField1)) {
            BurgerOrder order = new BurgerOrderBuilder()
                    .setFoodName(jLabel1.getText())
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BurgerToppings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BurgerToppings dialog = new BurgerToppings(new javax.swing.JFrame(), true);
