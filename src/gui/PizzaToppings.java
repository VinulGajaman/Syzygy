...
import static gui.IceCreamToppings.jLabel1;
 ...
 * @author Home
 */
public class PizzaToppings extends javax.swing.JDialog {

    private Menu myFrame;
    private OrderContext orderContext;
    private ComboExpression comboExpression;

    public PizzaToppings(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
// Terminal Expressions
    ...
    class ExtraPepporoniExpression implements OrderExpression {

        @Override
        public void interpret(OrderContext context) {
            context.addToOrder("Extra Pepporoni");
        }
    }

    class ExtraChickenExpression implements OrderExpression {

        @Override
        public void interpret(OrderContext context) {
            context.addToOrder("Extra Chicken");
        }
    }
        ...
        for (String command : commands) {
            switch (command.trim().toLowerCase()) {
                case "extra cheese":
                    ...
                    break;
                case "extra pepporoni":
                    comboExpression.addExpression(new ExtraPepporoniExpression());
                    break;
                case "extra chicken":
                    comboExpression.addExpression(new ExtraChickenExpression());
                    break;
                default:
...
/////////////////////////////////////////////Interprter Pattern////////////////////////////////////////////////////////////////////////////////
    private void updatePrice1(JCheckBox selectedCheckBox) {
        ...
        PizzaToppings.Topping topping = toppingFactory.getTopping(selectedToppingName, price);
        updatePrice(topping, jLabel6, selectedCheckBox.isSelected());
    }

    private void updatePrice2(JCheckBox selectedCheckBox) {
        String selectedToppingName = selectedCheckBox.getText();
        double price = 350.00;  // Set the default price or retrieve it based on the topping name
    ...
    private void updatePrice3(JCheckBox selectedCheckBox) {
        String selectedToppingName = selectedCheckBox.getText();
        double price = 300.00;  // Set the default price or retrieve it based on the topping name
    ...
    private void initComponents() {
        ...
        jCheckBox2.setText("Mozzarella cheese");
        ...
        jCheckBox3.setText("Pineapple chunks");
        ...
        jCheckBox4.setText("Red pepper flakes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PizzaToppings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PizzaToppings dialog = new PizzaToppings(new javax.swing.JFrame(), true);
